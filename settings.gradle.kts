...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      version("spring", "6.0.19")
      version("spring-boot", "3.1.10")
      library("data-commons", "org.springframework.data:spring-data-commons:3.1.11")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.1.11")
