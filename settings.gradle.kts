...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      version("spring", "6.2.0-RC2")
      version("spring-boot", "3.4.0-M3")
      library("data-commons", "org.springframework.data:spring-data-commons:3.4.0-RC1")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.4.0-RC1")
    ...
    create("opensearchLibs") {
      ...
      library("java-client", "org.opensearch.client:opensearch-java:2.15.0")
      ...
      library("testcontainers", "org.opensearch:opensearch-testcontainers:2.1.1") 
    }
