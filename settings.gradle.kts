...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      ...
      library("data-commons", "org.springframework.data:spring-data-commons:3.5.0-RC1")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.5.0-RC1")
