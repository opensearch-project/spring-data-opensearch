...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      ...
      version("spring-boot", "3.0.7")
      library("data-commons", "org.springframework.data:spring-data-commons:3.0.6")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.0.6")
