...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      ...
      library("data-commons", "org.springframework.data:spring-data-commons:3.1.3")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.1.3")
