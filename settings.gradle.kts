...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      ...
      library("data-commons", "org.springframework.data:spring-data-commons:3.2.3")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.2.3")
    ...
    create("opensearchLibs") {
      ...
      library("java-client", "org.opensearch.client:opensearch-java:2.9.0")
