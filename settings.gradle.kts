...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      ...
      library("data-commons", "org.springframework.data:spring-data-commons:3.2.4")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.2.4")
