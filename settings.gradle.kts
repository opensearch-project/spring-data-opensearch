...
dependencyResolutionManagement {
  versionCatalogs {
    ...
    create("springLibs") {
      ...
      library("data-commons", "org.springframework.data:spring-data-commons:3.0.7")
      library("data-elasticsearch", "org.springframework.data:spring-data-elasticsearch:5.0.7")
