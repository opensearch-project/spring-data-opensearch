...
@ContextConfiguration(classes = {InnerObjectOSCIntegrationTests.Config.class})
public class InnerObjectOSCIntegrationTests extends InnerObjectIntegrationTests {
    @Configuration
