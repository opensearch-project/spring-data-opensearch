...
@ContextConfiguration(classes = {ComplexCustomMethodRepositoryOSCIntegrationTests.Config.class})
public class ComplexCustomMethodRepositoryOSCIntegrationTests extends ComplexCustomMethodRepositoryIntegrationTests {
