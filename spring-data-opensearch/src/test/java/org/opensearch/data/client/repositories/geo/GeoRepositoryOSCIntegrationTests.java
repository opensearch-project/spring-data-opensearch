...
@ContextConfiguration(classes = {GeoRepositoryOSCIntegrationTests.Config.class})
public class GeoRepositoryOSCIntegrationTests extends GeoRepositoryIntegrationTests {
    @Configuration
