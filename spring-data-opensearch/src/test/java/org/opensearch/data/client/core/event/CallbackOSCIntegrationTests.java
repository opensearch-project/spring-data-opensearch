...
@ContextConfiguration(classes = {CallbackOSCIntegrationTests.Config.class})
class CallbackOSCIntegrationTests extends CallbackIntegrationTests {

    @Configuration
    @Import({OpenSearchTemplateConfiguration.class, CallbackIntegrationTests.Config.class})
    static class Config {
        @Bean
