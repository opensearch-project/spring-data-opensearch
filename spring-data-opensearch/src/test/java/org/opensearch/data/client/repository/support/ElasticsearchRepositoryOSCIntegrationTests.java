...
@ContextConfiguration(classes = {ElasticsearchRepositoryOSCIntegrationTests.Config.class})
public class ElasticsearchRepositoryOSCIntegrationTests extends ElasticsearchRepositoryIntegrationTests {
