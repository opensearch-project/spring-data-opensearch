...
@ContextConfiguration(classes = {SearchAfterOSCIntegrationTests.Config.class})
public class SearchAfterOSCIntegrationTests extends SearchAfterIntegrationTests {
