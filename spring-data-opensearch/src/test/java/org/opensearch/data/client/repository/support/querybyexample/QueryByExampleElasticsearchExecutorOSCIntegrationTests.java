...
@ContextConfiguration(classes = { QueryByExampleElasticsearchExecutorOSCIntegrationTests.Config.class })
public class QueryByExampleElasticsearchExecutorOSCIntegrationTests
