...
@ContextConfiguration(classes = {ComplexCustomMethodRepositoryManualWiringOSCIntegrationTests.Config.class})
public class ComplexCustomMethodRepositoryManualWiringOSCIntegrationTests
