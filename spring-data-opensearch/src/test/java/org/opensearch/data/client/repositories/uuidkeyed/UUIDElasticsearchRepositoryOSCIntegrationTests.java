...
@ContextConfiguration(classes = {UUIDElasticsearchRepositoryOSCIntegrationTests.Config.class})
public class UUIDElasticsearchRepositoryOSCIntegrationTests extends UUIDElasticsearchRepositoryIntegrationTests {
    @Configuration
