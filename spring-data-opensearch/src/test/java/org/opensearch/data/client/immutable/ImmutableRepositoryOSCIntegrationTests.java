...
@ContextConfiguration(classes = ImmutableRepositoryOSCIntegrationTests.Config.class)
public class ImmutableRepositoryOSCIntegrationTests extends ImmutableRepositoryIntegrationTests {
