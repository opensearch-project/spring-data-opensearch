...
@ContextConfiguration(classes = {SynonymRepositoryOSCIntegrationTests.Config.class})
public class SynonymRepositoryOSCIntegrationTests extends SynonymRepositoryIntegrationTests {
    @Configuration
