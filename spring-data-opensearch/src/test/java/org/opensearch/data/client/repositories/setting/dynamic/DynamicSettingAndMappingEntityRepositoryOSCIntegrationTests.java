...
@ContextConfiguration(classes = {DynamicSettingAndMappingEntityRepositoryOSCIntegrationTests.Config.class})
public class DynamicSettingAndMappingEntityRepositoryOSCIntegrationTests
