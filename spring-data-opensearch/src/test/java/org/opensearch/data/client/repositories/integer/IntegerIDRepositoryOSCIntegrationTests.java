...
@ContextConfiguration(classes = {IntegerIDRepositoryOSCIntegrationTests.Config.class})
public class IntegerIDRepositoryOSCIntegrationTests extends IntegerIDRepositoryIntegrationTests {
