...
@ContextConfiguration(classes = { ValueConverterOSCIntegrationTests.Config.class })
public class ValueConverterOSCIntegrationTests extends ValueConverterIntegrationTests {
