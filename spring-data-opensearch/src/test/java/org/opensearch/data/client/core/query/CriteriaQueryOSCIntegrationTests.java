...
@ContextConfiguration(classes = {CriteriaQueryOSCIntegrationTests.Config.class})
public class CriteriaQueryOSCIntegrationTests extends CriteriaQueryIntegrationTests {
