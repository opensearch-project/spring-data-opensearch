...
public abstract class OpenSearchConfiguration extends ElasticsearchConfigurationSupport {
     ...
     */
    @Bean
    public OpenSearchTransport elasticsearchTransport(RestClient restClient, JsonpMapper jsonpMapper) {
     ...
     */
    @Bean
    public OpenSearchClient elasticsearchClient(OpenSearchTransport transport) {
