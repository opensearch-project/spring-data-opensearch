...
class RequestFactory {
    ...
    public BulkRequest bulkRequest(List<?> queries, BulkOptions bulkOptions, IndexCoordinates index) {
        ...
        if (bulkOptions.getTimeout() != null) {
            bulkRequest.timeout(
                    TimeValue.timeValueMillis(bulkOptions.getTimeout().toMillis()));
        }
        ...
        if (bulkOptions.getWaitForActiveShards() != null) {
            bulkRequest.waitForActiveShards(
                    ActiveShardCount.from(bulkOptions.getWaitForActiveShards().value()));
        }
    ...
    public org.opensearch.index.reindex.ReindexRequest reindexRequest(ReindexRequest reindexRequest) {
        ...
        if (source.getRemote() != null) {
            ...
            QueryBuilder queryBuilder =
                    source.getQuery() == null ? QueryBuilders.matchAllQuery() : getQuery(source.getQuery());
            BytesReference query;
            try {
                XContentBuilder builder =
                        XContentBuilder.builder(QUERY_CONTENT_TYPE).prettyPrint();
        ...
        final org.springframework.data.elasticsearch.annotations.Document.VersionType versionType =
                dest.getVersionType();
        if (versionType != null) {
        ...
        if (script != null) {
            request.setScript(
                    new Script(DEFAULT_SCRIPT_TYPE, script.getLang(), script.getSource(), Collections.emptyMap()));
        }
        // endregion
    ...
    public DeleteByQueryRequest deleteByQueryRequest(
        ...
        if (query.hasScrollTime()) {
            ...
            deleteByQueryRequest.setScroll(
                    TimeValue.timeValueMillis(query.getScrollTime().toMillis()));
        }
    ...
    public IndexRequest indexRequest(IndexQuery query, IndexCoordinates index) {
        ...
        if (queryObject != null) {
            ...
            indexRequest = new IndexRequest(indexName)
                    .id(query.getId())
                    .source(query.getSource(), Requests.INDEX_CONTENT_TYPE);
        } else {
        ...
        if (query.getVersion() != null) {
            ...
            VersionType versionType =
                    retrieveVersionTypeFromPersistentEntity(queryObject != null ? queryObject.getClass() : null);
    ...
    public MoreLikeThisQueryBuilder moreLikeThisQueryBuilder(MoreLikeThisQuery query, IndexCoordinates index) {
        ...
        MoreLikeThisQueryBuilder moreLikeThisQueryBuilder =
                QueryBuilders.moreLikeThisQuery(fields, null, new MoreLikeThisQueryBuilder.Item[] {item});
    ...
    public UpdateRequest updateRequest(UpdateQuery query, IndexCoordinates index) {
        ...
        if (query.getFetchSourceIncludes() != null || query.getFetchSourceExcludes() != null) {
            List<String> includes =
                    query.getFetchSourceIncludes() != null ? query.getFetchSourceIncludes() : Collections.emptyList();
            List<String> excludes =
                    query.getFetchSourceExcludes() != null ? query.getFetchSourceExcludes() : Collections.emptyList();
    ...
    public UpdateByQueryRequest updateByQueryRequest(UpdateQuery query, IndexCoordinates index) {
        ...
        if (query.getQuery() != null) {
            ...
            if (queryQuery.getScrollTime() != null) {
                updateByQueryRequest.setScroll(
                        TimeValue.timeValueMillis(queryQuery.getScrollTime().toMillis()));
            }
        }
    ...
    private VersionType retrieveVersionTypeFromPersistentEntity(@Nullable Class<?> clazz) {
        ...
        ElasticsearchPersistentEntity<?> persistentEntity =
                clazz != null ? mappingContext.getPersistentEntity(clazz) : null;

        VersionType versionType = null;

        if (persistentEntity != null) {
            org.springframework.data.elasticsearch.annotations.Document.VersionType entityVersionType =
                    persistentEntity.getVersionType();
