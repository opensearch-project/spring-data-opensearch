...
public abstract class EntityCustomConversionIntegrationTests {
	...
	@WritingConverter
	public static class EntityToMapConverter implements Converter<Entity, Map<String, Object>> {
		@Override
	...
	@ReadingConverter
	public static class MapToEntityConverter implements Converter<Map<String, Object>, Entity> {
