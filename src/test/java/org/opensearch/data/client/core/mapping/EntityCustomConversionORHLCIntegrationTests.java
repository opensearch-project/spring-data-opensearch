...
@ContextConfiguration(classes = {EntityCustomConversionORHLCIntegrationTests.Config.class})
public class EntityCustomConversionORHLCIntegrationTests extends EntityCustomConversionIntegrationTests {
